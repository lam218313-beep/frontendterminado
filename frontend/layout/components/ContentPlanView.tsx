    ...
    return (
        <div className='p-8 h-full overflow-y-auto custom-scrollbar animate-fade-in-up'>
            <div className="max-w-5xl mx-auto">
                ...
                <div className='mb-8'>
                    <h2 className='text-3xl font-black text-brand-dark mb-2 tracking-tight'>Plan de Contenido</h2>
                    <p className='text-gray-500'>Estructura de pilares y cronograma mensual.</p>
                </div>
                <div className='bg-white/50 backdrop-blur-xl rounded-[30px] p-12 border border-white shadow-sm flex items-center justify-center min-h-[400px]'>
                    <div className="text-center text-gray-400">
                        ...
                        <p>Visualización de la estrategia y calendario de contenidos.</p>
                    </div>
                </div>
            </div>
        </div>
