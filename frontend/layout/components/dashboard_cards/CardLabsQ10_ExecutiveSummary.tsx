                ...
                <div className="absolute inset-0 bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 [backface-visibility:hidden] flex flex-col z-10">
                    ...
                    <div className="flex-1 flex flex-col gap-6 min-h-0">
                        ...
                        <div className="flex-1 flex flex-col md:flex-row gap-6 min-h-0">
                            ...
                            <div className="w-full md:w-1/3 min-w-[180px] bg-gray-50/50 rounded-3xl border border-gray-100 flex flex-col items-center justify-center relative p-4 shrink-0">
