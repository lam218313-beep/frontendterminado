...
import { Calendar, Clock, CheckCircle2, FileText, AlertCircle, ExternalLink } from 'lucide-react';
...
export const RightSidebar: React.FC<RightSidebarProps> = ({ onNavigateToTasks }) => {
  ...
  return (
    <aside className="w-[340px] bg-white h-[calc(100vh-2rem)] my-4 mr-4 p-8 flex flex-col shrink-0 overflow-x-hidden overflow-y-auto hidden xl:flex z-10 shadow-sm border border-gray-100 rounded-[30px] relative font-sans">
        <h2 className="text-xl font-bold text-brand-dark mb-6">Tareas</h2>
