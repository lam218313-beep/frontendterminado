...
const MicroTopicCard: React.FC<{ topic: TopicData; index: number }> = ({ topic, index }) => {
  ...
  return (
    <div 
      className="relative h-full min-h-[360px] w-full [perspective:1000px] group cursor-pointer"
          ...
          <div className="w-full flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-400 font-medium">Análisis de Tópico</p>
                </div>
            </div>
